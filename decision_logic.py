...
distance = ctrl.Antecedent(np.arange(0, 1001, 10), 'distance')
...
intent['medium'] = fuzz.trimf(intent.universe, [0, 5, 10])
...
rule2 = ctrl.Rule(distance['average'] & speed['good'], intent['medium'])
...
intention.input['speed'] = 61
intention.input['distance'] = 434
